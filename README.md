...
> Note: An advanced transformer-based multi-head synergistic attention netowrk, which outprtforms this version on all three benchmark datasets by a large margin, is available. The codes will be released soon.
